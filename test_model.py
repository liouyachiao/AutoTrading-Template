...
predict_3.append(output_data[2])
cache = output_data[0]
...
with open('test.csv', "w") as output_file:
    for i in range(df_test.shape[0] - 1):
        ...
        dp1 = [output_data[1] - output_data[0], output_data[2] - output_data[1]]
        dp2 = dp1[1] - dp1[0]
        cache = output_data[0]
...
ax.plot(predict_3, label = 'predict 3')
ax.legend()
ax.set_xlabel('index')
